...
class Playground(models.Model):
    ...
    open_hours = models.TimeField(auto_now=False, auto_now_add=False, verbose_name='Время открытия')
    close_hours = models.TimeField(default='00:00', verbose_name='Время закрытия')
